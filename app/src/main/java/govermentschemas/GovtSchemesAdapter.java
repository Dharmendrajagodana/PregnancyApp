...
public class GovtSchemesAdapter extends ArrayAdapter<GovtSchemeObjectClass> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView t = listItemView.findViewById(R.id.govt_scheme_name_textview);
        t.setText(govtSchemeObjectClass.getName());

        TextView desc_eng = listItemView.findViewById(R.id.govt_scheme_detail_textview);
