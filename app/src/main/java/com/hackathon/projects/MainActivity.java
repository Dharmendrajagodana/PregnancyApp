...
import hospitaldata.hospitalListActivity;
...
//        }
    ...
    public ArrayList<Hospital> searchResult(ArrayList<Hospital> hospitalArrayList) {
        ...
        for (int i = 0; i < hospitalArrayList.size(); i++) {
            ...
            if ((currHospital.getCategory().contains(type) || type.equals("All"))
                    /**/ && (currHospital.getSystemsOfMedicine().contains(system_medi) || system_medi.equals("All"))
