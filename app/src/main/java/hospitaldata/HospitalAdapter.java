...
public class HospitalAdapter extends ArrayAdapter<Hospital> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView t = listItemView.findViewById(R.id.hospital_name_textView);
        ...
        ImageView imageView = listItemView.findViewById(R.id.text_drawable_imageView);
