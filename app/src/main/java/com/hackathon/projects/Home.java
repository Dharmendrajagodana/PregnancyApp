...
import govermentschemas.GovtInitiatives;
...
public class Home extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        //make list of hospital from the data.csv file
        new HospitalAsyncTask().execute();
        Button search_hospital_button = findViewById(R.id.search_hospital_button);
        Button guidelines_button = findViewById(R.id.guidelines_button);
        Button knowledge_button = findViewById(R.id.knowledge_button);
        Button vaccination_details_button = findViewById(R.id.vaccination_details_button);
        Button search_on_map_button = findViewById(R.id.search_on_map_button);
        //        Button feedbackButton = (Button) findViewById(R.id.feedback_button);
        //        Button aboutButton = (Button) findViewById(R.id.about_button);
        Button govt_initiatives_button = findViewById(R.id.govt_initiatives_button);

        search_hospital_button.setOnClickListener(new View.OnClickListener(){
            @Override
        ...
        vaccination_details_button.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v){
        ...
        guidelines_button.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v){
        ...
        search_on_map_button.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v){
        ...
        govt_initiatives_button.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v){
    ...
    public boolean onNavigationItemSelected(MenuItem item){
        ...
        if(id == R.id.nav_signout){
            ...
            String arr[] = {"This app helps you to locate nearest hospitals and medical centers. Also you can find guidelines for both mother and child. " + "Vaccination forms are given so that you can keep the vaccination record of your child. \n"};
            AlertDialog.Builder builder = new AlertDialog.Builder(Home.this);
            builder.setTitle("About the app").setItems(arr, new DialogInterface.OnClickListener(){
                public void onClick(DialogInterface dialog, int which){
                    // The 'which' argument contains the index position
                    // of the selected item
                }
            ...
            String shareBody = "Share this app with your friends and family. Download MyPragnancy App";
